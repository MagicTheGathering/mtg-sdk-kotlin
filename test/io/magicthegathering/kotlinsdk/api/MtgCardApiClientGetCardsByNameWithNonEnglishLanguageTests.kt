...
class MtgCardApiClientGetCardsByNameWithNonEnglishLanguageTests {
    ...
    fun getCardsByPartialNameWithNonEnglishLanguageNoResult() {
        MtgCardApiClient.getCardsByPartialNameWithNonEnglishLanguage("spanish", "no_card", 10, 1).subscribe { cards ->
    ...
    fun getCardsByPartialNameWithNonEnglishLanguage() {
        MtgCardApiClient.getCardsByPartialNameWithNonEnglishLanguage("spanish", "jace", 2, 1).subscribe { cards ->
    ...
    fun getCardsByExactNameWithNonEnglishLanguageNoResult() {
        MtgCardApiClient.getCardsByExactNameWithNonEnglishLanguage("spanish", "no_card", 10, 1).subscribe { cards ->
            Assert.assertTrue(cards.isEmpty())
        }
    }
    ...
    fun getCardsByExactNameWithNonEnglishLanguage() {
        MtgCardApiClient.getCardsByExactNameWithNonEnglishLanguage("spanish", "zurgo aplastacráneos", 3, 1).subscribe { cards: List<MtgCard> ->
            cards.forEach { card ->
